...
");
        ...
        public static void ChangeDate(Table booking, dynamic currentuserdata)
        {
            ...
            while (!validDate)
            {
                ...
                if (isValidDateTime && parsedDateTime > DateTime.Now)
                {
                    string formattedDateTime = parsedDateTime.ToString(format);
                    //Console.WriteLine("Valid DateTime: " + formattedDateTime);
                    validDate = true;
                }
                else
                {
...
");
            ...
            {  
                ...
                if (Convert.ToInt32(newPartySize) <= booking.PartySize)
                {
                    validSize = true;
                ...
                {
                    Console.WriteLine(@"
You can only change your party size to a smaller group.
